...
export const ScrollAwareVisibility: Story = {
	render: (args) => {
		...
		return (
			<>
				...
				>
					<FloatingActionButton {...args} icon={<PlusIcon />} label="Add Item" extended={false} />
				</div>
			</>
		);
	},
	args: {
		// Default args for the FAB within this context
		// extended prop is always false, visibility controlled by render function
	},
	parameters: {
		layout: 'fullscreen',
	},
	name: 'Scroll-aware Visibility (Animated)',
};