...
export const EmptyState = ({ title, message, buttonText, onButtonClick }: { title: string, message: string, buttonText?: string, onButtonClick?: () => void }) => (
	...
	>
		<Card variant='outlined' className='border-dashed w-2xl flex flex-col gap-4 items-center justify-center py-16 group hover:bg-surface-variant/50 transition-colors duration-300'>
